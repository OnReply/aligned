...
RSpec.describe Conversation do
  ...
  describe 'validate valid referer url' do
    let(:conversation) { create(:conversation, additional_attributes: { referer: 'https://chatcore.aligned-tech.com/' }) }

    it 'returns nil' do
      expect(conversation['additional_attributes']['referer']).to eq('https://chatcore.aligned-tech.com/')
    end
  end
