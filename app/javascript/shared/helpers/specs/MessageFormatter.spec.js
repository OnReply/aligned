...
describe('#MessageFormatter', () => {
  describe('content with links', () => {
    it('should format correctly', () => {
      const message =
        'Asigned is an opensource tool. [Chatwoot](https://chatcore.aligned-tech.com)';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Chatwoot is an opensource tool. <a href="https://chatcore.aligned-tech.com" class="link" rel="noreferrer noopener nofollow" target="_blank">Chatwoot</a></p>'
      );
    });
    it('should format correctly', () => {
      const message =
      ...
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Chatwoot is an opensource tool. <a href="https://chatcore.aligned-tech.com" class="link" rel="noreferrer noopener nofollow" target="_blank">https://chatcore.aligned-tech.com</a></p>'
      );
    });
  });
...
<h2>tool</h2>`
  ...
  describe('tweets', () => {
    it('should return the same string if not tags or @mentions', () => {
      const message = 'Asigned is an opensource tool';
